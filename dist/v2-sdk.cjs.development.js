...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new sdkCore.Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'OSLP', 'OracleSwap V2 LP');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    var factoryAddress = (_V2_FACTORY_ADDRESSES = sdkCore.V2_FACTORY_ADDRESSES[tokenA.chainId]) != null ? _V2_FACTORY_ADDRESSES : sdkCore.V2_FACTORY_ADDRESS;
