import { Percent, CurrencyAmount, sqrt, Token, Price, V2_FACTORY_ADDRESSES, V2_FACTORY_ADDRESS, TradeType, Fraction, computePriceImpact, sortedInsert, validateAndParseAddress } from '@uniswap/sdk-core';
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'OSLP', 'OracleSwap V2 LP');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    var factoryAddress = (_V2_FACTORY_ADDRESSES = V2_FACTORY_ADDRESSES[tokenA.chainId]) != null ? _V2_FACTORY_ADDRESSES : V2_FACTORY_ADDRESS;
...
export { INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Route, Router, Trade, computePairAddress, inputOutputComparator, tradeComparator };
